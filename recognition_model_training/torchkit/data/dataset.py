...
from .parser import IndexParser, ImgSampleParser, TFRecordSampleParser,TFRReverseLatentParser
...
class MultiDataset(Dataset):
    ...
    def __init__(self, data_root, index_root, names, transform, **kwargs) -> None:
        ...
        if 'TFR' not in names[0] and 'TFR' not in kwargs:
            ...
            # 原来：self.sample_parser = TFRecordSampleParser(transform)
             self.sample_parser = TFRReverseLatentParser() # 修改为Reverse latent z的TFRecord的解释器
